...
*  OpenID Connect Session Management
     ...
     OpenID Connect Provider (OP) minimizing the network traffic. This will be supported with WSO2 IS 5.2.0.

* Last SAML based login timestamp and Last password modified Timestamp

     WSO2 IS 5.2.0 is now able to know the last login time and last password updated time of a user.
     You should be able to see the corresponding values listed through the user's profile.

*  API to get the number (count) of users

     One of the new functionalities introduced with WSO2 IS 5.2.0 is the service to count the number of users
...
*  Support for Microsoft Office 365 ??? WS Trust
     ...
     With WSO2 IS 5.2.0, you will be able to successfully configure the WS-Trust protocol for
...
*  SAML2.0 support for WS-Federation Passive
     ...
     WSO2 IS 5.2.0 is now able to support SAML2.0 tokens with Passive STS.
